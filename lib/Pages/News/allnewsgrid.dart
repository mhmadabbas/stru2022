...
class newsallg extends StatefulWidget {
  Map<String, dynamic> pp;
  newsallg({Key? key,required this.pp}) : super(key: key);


  @override
  _newsallgState createState() => _newsallgState();
}



class _newsallgState extends State<newsallg> {
  bool issearch = false;
  String searchvalue = '';
